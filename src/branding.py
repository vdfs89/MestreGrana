...
def _clean_html(html_str: str) -> str:
    """Remove recuos e linhas vazias do HTML para evitar blocos de código markdown indesejados no Streamlit."""
...
def render_section_divider(title=""):
    ...
    """
    st.markdown(_clean_html(divider_html), unsafe_allow_html=True)
